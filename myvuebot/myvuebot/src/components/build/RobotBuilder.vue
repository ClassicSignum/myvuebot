<template>
    ...
    <div class="top-row">
     ...
     <!-- if u put v-once like this: <div v-once class="".. then this part will only change once -->
...
export default {
  ...
  computed: {
    ...
    armBorderMatchStyle() {
      return {
        backgroundColor: this.selectedRobot.head.onSale
          ? '#aaa' : '#fff',
      };
    },
    armBorderStyle() {
      return {
        border: this.selectedRobot.leftArm.title === this.selectedRobot.rightArm.title
          ? '9px solid green'
          : '9px solid yellow',
      };
    },

...
export default {
  ...
  computed: {
    selectedPart() {
    //   console.log(this.parts[this.selectedPartIndex]);
      return this.parts[this.selectedPartIndex];
    },
  },
  created() {
    this.emitSelectedPart();// life cycle called at first
  },
  updated() {
    this.emitSelectedPart();// life cycle called everytime sth changes
  },
  methods: {
    showPartInfo() {
      this.$router.push({
